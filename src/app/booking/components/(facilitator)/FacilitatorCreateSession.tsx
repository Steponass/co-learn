...
<h3 className={classes.list_heading}>Create New Session</h3>
<form
...
<input type="hidden" name="is_recurring" value={isRecurring.toString()} />
    ...
    <div className={classes.session_time_input_container}>
      ...
      <textarea
        name="description"
        placeholder="Brief description of what you'll cover (max 80 chars)"
        maxLength={80}
        className={classes.datetime_picker}
        rows={2}
      />
      ...
      {isRecurring && (
        <div className={classes.recurring_options + " stack"}>
          <div className={classes.session_time_input_container}>
            ...
            <select name="frequency" className={classes.dropdown} defaultValue="weekly">
